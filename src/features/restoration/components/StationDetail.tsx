...
export function StationDetail({ row, areaName, onClose }: StationDetailProps) {
  if (!row)
    return (
      <aside className="rc-panel rc-detail rc-detail--empty" aria-label="تفاصيل المحطة">
        <Icon name="map" size={28} />
        <p>اختر محطة من الخريطة أو من جدول الأولويات لعرض التحليل الهندسي لفقدها.</p>
      </aside>
    )
  ...
  return (
    <aside className="rc-panel rc-detail" aria-label="تفاصيل المحطة">
