...
interface DashboardProps {
  ...
  /** Stations the workbook brought along go first, then the plans — the one save that
   *  PlanActions.saveMany does not cover, since it takes no stations. */
